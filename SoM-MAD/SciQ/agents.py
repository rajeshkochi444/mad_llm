...
def  agent_student1(llm):
    return Agent(
            role = dedent(f"""\
                        A Science Student with great knowledge in science topics at Georgia Tech University"""
                        ),
            goal = dedent(f"""\
                        Select the correct answer label from the given options for the science question.
            ...
            backstory = dedent("""\
                            You are one of the best students in the Science department of the university. 
                            You can easily answer any science question with your arguments and reasonings. 
                            You debate with others on their arguments on any given science question with your arguments and reasonings."""
                            ),
            llm = llm,
            verbose=True,
...
def agent_student2(llm):
    return Agent(
            role = dedent(f"""\
                        A Science Student at Georgia Tech University"""
                        ),
            goal = dedent(f"""\
                        Debate with your friend on the given science question with your arguments and reasonings. His debate arguments are given as context.
                        Update or correct your answer if you believe your friend's arguments and reasonings are valid 
                        Select the correct answer from the given options after debating your friend on the science question"""
                        ),
            backstory = dedent("""\
                            You are one of the best students in the Science department of the university.  
