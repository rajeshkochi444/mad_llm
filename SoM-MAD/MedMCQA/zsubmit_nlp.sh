...
echo "Starting at "`date`
cp final_gpt_answer_extraction_MedQ_original.py final_gpt_answer_extraction_0.py
...
echo "Starting at "`date`
cp final_gpt_answer_extraction_MedQ_original.py final_gpt_answer_extraction_1.py
...
echo "Starting at "`date`
cp final_gpt_answer_extraction_MedQ_original.py final_gpt_answer_extraction_2.py
...
echo "Starting at "`date`
cp final_gpt_answer_extraction_MedQ_original.py final_gpt_answer_extraction_3.py
