...
def task_kickoff(science_question, options, agent):
  return Task(
            description=  dedent(f"""\
                                  Give the correct answer label from the options given: {options} for the science question: {science_question}. 
                                  Think step by think
                                  Give detailed reasonings and arguments for selecting your answer."""),
          
            expected_output= dedent(f"""\
                                    Detailed summary of your reasonings and arguments for selecting the answer for the given science question. 
...
def task_debate_student1(science_question, options, agent, debate_student2):
  return Task(
            description=  dedent(f"""\
                                  Give the correct answer label from the options given: {options} for the science question: {science_question}. Think step by step. 
                                  Give detailed reasonings and arguments for selecting your answer.
                                  ...
                                  If your friend's debate provide you new insights, update your reasoning about answering the science question.
...
def task_debate_student2(science_question, options, agent, debate_student1):
    return  Task(
        description= dedent(f"""\
                            You are big critic of your friend and always debate with him with your counter arguments and reasonings on the given science question: {science_question} 
                            You always disgree with your friend and provide alternative pathways to answer the question.  Your respone must start with "I disgree with you. Here are my reasons/arguments"
                            After debate with your friend, give the correct answer and select the correct answer label from  the options {options}  
                            You may also use your previous conversations and contexts from memory for your argumnets and reasonings for your answer.                            
                            ."""
                            ),
        expected_output = dedent(f""" \
                                A detailed summary of your reasonings and arguments for selecting the answer for the given science question.
